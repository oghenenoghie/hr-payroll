...
description: 'Senior SaaS UX/UI architect methodology for auditing and improving Wagebook/Plutus (the HR/payroll app in this repo) into a professional, enterprise-grade "payroll & workforce operating system" — without blindly rewriting what already works. Use this whenever the user asks to improve the dashboard, redesign a screen, rethink the information architecture/navigation, make the app feel more "enterprise" or "professional" or comparable to Stripe/Linear/Rippling/Deel/Gusto/BambooHR/Workday, add an exceptions/approvals/audit workflow, make payroll calculations explainable, add role-specific dashboards, or otherwise do a UX/product audit of any part of the app — even if they do not use the word "skill" or name this file. Trigger proactively on phrases like "make this look more professional", "audit the UI", "this feels basic", "improve the workflow", "what should the dashboard show", or any request to add charts/widgets/tables/reports to an existing screen. ALWAYS load this together with (never instead of) the plutus-payroll-platform skill — this skill is the design/audit methodology, that skill is the ground truth for what is already built, what the design tokens are, and what the domain rules are.'
---
