      ...
      <header className="flex flex-col gap-1">
        <div className="flex items-center justify-between">
          ...
          {customers && customers.length > 0 && (
            <ExportCsvButton csv={csv} filename="customers.csv" label="Export this page (CSV)" />
          )}
        </div>
      ...
      {totalPages > 1 && (
        <div className="flex items-center justify-between">
          <span className="text-[12px] text-ink-soft">
            Page {currentPage} of {totalPages} · {totalCustomers} customer{totalCustomers === 1 ? "" : "s"} total
          </span>
