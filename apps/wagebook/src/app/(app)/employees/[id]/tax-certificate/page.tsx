...
export default async function EmployeeTaxCertificatePage({
  params,
  searchParams,
}: {
  ...
  const { data: employee } = await supabase.from("employees").select("id, full_name, tin").eq("id", id).maybeSingle();
